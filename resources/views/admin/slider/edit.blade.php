                ...
                <div class="col-lg-12">
                    ...
                    <section class="content-header">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item activew">Edit Slider</li>
                        </ol>
                    </section>
                                    ...
                                    <div class="col">
                                        ...
                                        <form  action="{{route('slider.update',$slider->id)}}" method="POST"  enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="title" id="title" class="form-control" value="{{$slider->title}}"> </div>
                                            </div>
                                            ...
                                            <div class="text-xs-right">
                                                <button type="submit" id="submit" class="btn btn-info">Update Slider</button>
                                            </div>
